      ...
      <div className="px-6 pb-6 grid grid-cols-2 gap-5">
        ...
        <Card variant="default" padding="none">
          <div className="p-5">
            ...
            <div className="flex items-center gap-2 py-3 px-4 bg-white border-2 border-ak-primary/20 rounded-lg mb-4 transition-all hover:border-ak-primary/40 focus-within:border-ak-primary focus-within:shadow-sm">
              <Search size={20} className="text-ak-primary" />
              <input
                type="text"
                placeholder="Søk etter spiller..."
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                className="flex-1 border-none bg-transparent outline-none text-[15px] text-ak-text-primary placeholder:text-ak-text-secondary"
              />
            </div>
          ...
          <div className="p-5">
            {user?.id && defaultTeamId ? (
              ...
              <div>
                ...
                <div className="text-center py-8 px-4">
                  <Users size={32} className="text-ak-border-default mb-2 mx-auto" />
                  <p className="text-[15px] text-ak-text-secondary">
