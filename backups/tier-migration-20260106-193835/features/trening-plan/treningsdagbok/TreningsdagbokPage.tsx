    ...
    <>
      ...
      <div className="flex flex-col h-full min-h-screen bg-ak-surface-base">
        ...
        <PageHeader
          ...
          subtitle="Oversikt over all trening og utvikling"
          actions={
            <button
        ...
        <div className="flex flex-1 overflow-hidden" style={{ minHeight: '500px' }}>
          ...
          <div className="dagbok-side-column w-80 border-l border-ak-border-default bg-ak-surface-subtle p-4 overflow-auto flex flex-col gap-4" style={{ minHeight: '500px' }}>
            {/* Summary stats */}
            <DagbokSummarySection stats={stats} isLoading={isLoading} />
