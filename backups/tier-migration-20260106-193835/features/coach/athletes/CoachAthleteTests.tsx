...
const TEST_CATEGORIES = [
  ...
  { id: 'speed', label: 'Fart', icon: '⚡' },
  { id: 'distance', label: 'Distanse', icon: '📏' },
...
function TestResultCard({ test }: { test: typeof MOCK_TEST_RESULTS[0] }) {
  ...
  return (
    <div className="bg-ak-surface-card rounded-lg border border-ak-border-default p-4 hover:border-ak-primary transition-colors">
      {/* Header */}
      <div className="flex items-start justify-between mb-3">
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            <span className="text-xs font-semibold text-ak-text-tertiary">
          ...
          <h3 className="font-semibold text-ak-text-primary text-sm">
            {test.testName}
          </h3>
        </div>
      ...
      <div className="mb-3">
        <div className="flex items-baseline gap-2">
          ...
          {test.unit && (
            <span className="text-sm text-ak-text-secondary">{test.unit}</span>
          )}
        </div>
      ...
      {/* History mini chart */}
      <div className="mb-2">
        <div className="text-xs text-ak-text-tertiary mb-1">Historikk</div>
    ...
    return (
      <div className="max-w-6xl mx-auto text-center py-16">
        <div className="w-20 h-20 rounded-full bg-ak-surface-subtle flex items-center justify-center mx-auto mb-4">
          <AlertCircle size={40} className="text-ak-text-tertiary" />
        </div>
        ...
        <button
          ...
          className="px-6 py-3 bg-ak-primary text-white rounded-lg font-medium hover:bg-ak-primary/90 transition-colors mt-4"
        >
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-ak-surface-card rounded-lg border border-ak-border-default p-4">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg border text-sm font-medium transition-colors ${
                selectedCategory === category.id
                  ...
                  : 'bg-ak-surface-card border-ak-border-default text-ak-text-primary hover:border-ak-primary'
              }`}
            >
      ...
      <div>
        ...
        {filteredTests.length > 0 ? (
          ...
          <div className="text-center py-12 bg-ak-surface-card rounded-lg border border-ak-border-default">
            <Target size={48} className="text-ak-text-tertiary mx-auto mb-3" />
            <p className="text-ak-text-secondary">
