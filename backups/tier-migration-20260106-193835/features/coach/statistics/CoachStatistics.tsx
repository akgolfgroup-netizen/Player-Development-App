...
function StatCard({
  ...
  return (
    <div className="bg-ak-surface-card rounded-xl border border-ak-border-default p-5">
      <div className="flex items-center gap-3 mb-3">
        ...
        <span className="text-sm font-medium text-ak-text-secondary">{label}</span>
      </div>
      <div className="text-3xl font-bold text-ak-text-primary">
        {value}
        {suffix && <span className="text-lg font-normal text-ak-text-secondary ml-1">{suffix}</span>}
      </div>
    </div>
  );
}
...
function AthleteRow({
  ...
  return (
    ...
    >
      {/* Trend indicator */}
      <div className="w-10 h-10 rounded-lg bg-ak-surface-subtle flex items-center justify-center">
