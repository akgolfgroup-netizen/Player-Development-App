  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        ...
        >
          <GripVertical size={18} className="text-ak-text-tertiary" />
        </div>
...
const DraggableSession: React.FC<DraggableSessionProps> = ({ session }) => {
  ...
  return (
    <div
      ...
      {...attributes}
      {...listeners}
      className="p-3 rounded-lg bg-ak-surface-base border border-ak-border-default hover:border-ak-primary/50 hover:shadow-sm cursor-grab active:cursor-grabbing transition-all"
    >
    ...
    >
      <div className="min-h-screen bg-ak-surface-subtle flex flex-col">
        ...
        <div className="flex-1 flex overflow-hidden">
            ...
            <div className="p-6">
              {plan.periods.length === 0 ? (
                <div className="text-center py-20">
                  <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-ak-surface-subtle flex items-center justify-center">
                    <Calendar size={32} className="text-ak-text-tertiary" />
                  </div>
          ...
          {/* Right Sidebar */}
          <div className="w-80 bg-ak-surface-base border-l border-ak-border-default flex flex-col">
            {/* Period Library */}
                ...
                {(Object.keys(PERIOD_CONFIG) as PeriodType[]).map((type) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full p-3 rounded-lg border border-ak-border-default bg-ak-surface-base hover:border-ak-primary/50 hover:shadow-sm transition-all text-left`}
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <Plus size={16} className="text-ak-text-tertiary" />
                      </div>
                    </button>
                  );
                })}
