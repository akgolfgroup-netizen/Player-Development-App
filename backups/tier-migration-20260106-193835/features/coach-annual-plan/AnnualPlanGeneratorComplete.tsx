  ...
  <div className="min-h-[60vh] flex items-center justify-center p-6">
    <div className="max-w-4xl w-full">
      <div className="text-center mb-8">
        ...
        <p className="text-ak-text-secondary text-[15px]">
          For {playerName}
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        <Card
          variant="default"
          padding="none"
          className="cursor-pointer transition-all hover:shadow-lg hover:border-ak-primary/30 group"
          onClick={() => onSelectMode('template')}
        >
          <div className="p-8 text-center">
            <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-ak-primary/15 flex items-center justify-center group-hover:bg-ak-primary/25 transition-colors">
              <Layout size={32} className="text-ak-primary" />
            </div>
        ...
        >
          <div className="p-8 text-center">
            <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-ak-surface-subtle flex items-center justify-center group-hover:bg-ak-border-default transition-colors">
              <Plus size={32} className="text-ak-text-primary" />
            </div>
            ...
            <div className="flex flex-col gap-2 text-left">
              <div className="flex items-center gap-2 text-xs text-ak-text-secondary">
                <div className="w-1.5 h-1.5 rounded-full bg-ak-border-default" />
...
const TimelineHeader: React.FC<TimelineHeaderProps> = ({
  ...
  return (
    <div className="sticky top-0 bg-ak-surface-base z-10 border-b border-ak-border-default">
      <div className="flex items-center justify-between p-4">
        ...
        <div className="flex gap-1 p-1 bg-ak-surface-subtle rounded-lg">
          <button
            onClick={() => onViewChange('month')}
            className={`px-3 py-1 text-xs font-medium rounded-md transition-colors ${
              currentView === 'month'
                ? 'bg-white text-ak-primary shadow-sm'
      ...
      <div className="flex border-t border-ak-border-default">
        {months.map((month, index) => (
          <div
            key={index}
            className="flex-1 px-3 py-2 text-center border-r border-ak-border-default last:border-r-0"
          >
            <div className="text-xs font-semibold text-ak-text-primary uppercase">
  ...
  return (
    ...
    >
      ...
      {period.goals.length > 0 && (
        <div className="mt-2 pt-2 border-t border-ak-border-default">
...
const AnnualPlanGenerator: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-ak-surface-subtle flex flex-col">
      {/* Header */}
      <div className="bg-ak-surface-base border-b border-ak-border-default py-4 px-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-ak-text-secondary mt-1">{plan.playerName}</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          {/* Save status */}
          {saveStatus === 'success' && (
            <div className="flex items-center gap-2 text-sm text-ak-status-success">
              <CheckCircle size={18} />
              <span>Lagret!</span>
            </div>
          )}
          {saveStatus === 'error' && (
            <div className="flex items-center gap-2 text-sm text-ak-status-error">
              <AlertCircle size={18} />
      ...
      <div className="flex flex-1 overflow-hidden">
            ...
            {plan.periods.length === 0 ? (
              <div className="h-full flex items-center justify-center">
                <div className="text-center max-w-md">
                  <Layers size={48} className="mx-auto mb-4 text-ak-text-tertiary" />
        ...
        {/* Sidebar */}
        <div className="w-80 bg-ak-surface-base border-l border-ak-border-default overflow-hidden flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-4">
            <div className="space-y-3 mb-6">
              {Object.entries(PERIOD_CONFIG).map(([type, config]) => (
                ...
                >
                  ...
                  <p className="text-xs text-ak-text-secondary mb-1">
                    {config.description}
                  </p>
                  <div className="text-xs text-ak-text-tertiary">
            ...
            <div className="border-t border-ak-border-default pt-4">
              <div className="text-xs font-medium text-ak-text-secondary mb-2">ØKTER</div>
              <SessionLibrary />
            </div>
          </div>
        </div>
