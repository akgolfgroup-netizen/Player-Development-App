...
const tw = {
  ...
  textarea: 'w-full py-2 px-3 bg-surface-elevated border border-border rounded-ak-md text-[var(--text-inverse)] text-sm placeholder-[var(--video-text-tertiary)] min-h-[120px] resize-y',
  ...
  autoGenerateButton: 'py-2 px-4 bg-purple-500/20 border border-purple-500 rounded-ak-md text-purple-500 text-sm font-medium cursor-pointer hover:bg-purple-500/30 transition-colors',
