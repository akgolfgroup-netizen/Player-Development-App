...
const tw = {
  ...
  card: 'p-4 bg-surface rounded-ak-lg border border-border hover:border-primary transition-colors cursor-pointer',
  ...
  statusBadge: {
    ...
    published: 'inline-flex py-1 px-2 bg-ak-status-success/20 border border-ak-status-success rounded-ak-sm text-ak-status-success text-xs font-medium',
  },
