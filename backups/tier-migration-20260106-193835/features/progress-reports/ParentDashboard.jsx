...
const tw = {
  ...
  welcomeCard: 'p-6 bg-gradient-to-r from-primary/20 to-purple-500/20 rounded-ak-lg border border-primary',
  ...
  statCard: 'p-4 bg-surface rounded-ak-lg border border-border',
  ...
  reportCard: 'p-4 bg-surface rounded-ak-lg border border-border hover:border-primary transition-colors cursor-pointer',
  ...
  contactCoachCard: 'p-4 bg-purple-500/10 rounded-ak-lg border border-purple-500',
  contactTitle: 'text-sm font-semibold text-[var(--text-inverse)] mb-2',
  contactText: 'text-xs text-[var(--video-text-secondary)] mb-3',
  contactButton: 'py-2 px-4 bg-purple-500 border-2 border-purple-500 rounded-ak-md text-white text-sm font-medium cursor-pointer hover:bg-purple-600 transition-colors',
};
