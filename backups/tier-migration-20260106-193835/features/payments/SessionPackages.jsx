...
const tw = {
  ...
  packageCard: 'p-6 bg-surface rounded-ak-lg border border-border hover:border-primary transition-all',
  popularBadge: 'inline-flex py-1 px-3 bg-primary/20 border border-primary rounded-ak-md text-primary text-xs font-semibold mb-2',
  ...
  purchaseButton: 'w-full py-2 px-4 bg-primary border-none rounded-ak-md text-white text-sm font-medium cursor-pointer hover:opacity-90 transition-opacity',
  ownedPackagesList: 'flex flex-col gap-3',
  ownedPackageCard: 'p-4 bg-surface rounded-ak-lg border border-border flex items-center gap-4',
        ...
        <div className={tw.modal} onClick={() => setShowConfirmModal(false)}>
          <div className={tw.modalCard} onClick={(e) => e.stopPropagation()}>
            ...
            <div>
              ...
              <div className="p-4 bg-surface-elevated rounded-ak-md">
