...
const tw = {
  ...
  currentPlanCard: 'p-6 bg-surface rounded-ak-lg border-2 border-primary',
  planCard: 'p-6 bg-surface rounded-ak-lg border border-border hover:border-primary transition-all cursor-pointer',
  ...
  featureIcon: 'text-ak-status-success',
  currentBadge: 'py-1 px-3 bg-primary/20 border border-primary rounded-ak-md text-primary text-xs font-semibold',
  planActions: 'flex gap-2',
  upgradeButton: 'py-2 px-4 bg-primary border-none rounded-ak-md text-white text-sm font-medium cursor-pointer hover:opacity-90 transition-opacity',
  cancelButton: 'py-2 px-4 bg-ak-status-error/10 border border-ak-status-error rounded-ak-md text-ak-status-error text-sm font-medium cursor-pointer hover:bg-ak-status-error/20 transition-colors',
  ...
  warningBox: 'p-4 bg-yellow-500/10 border border-yellow-500 rounded-ak-md',
