...
const tw = {
  ...
  exportButton: 'py-2 px-4 bg-surface-elevated border border-border rounded-ak-md text-[var(--text-inverse)] text-sm font-medium cursor-pointer hover:bg-surface-elevated-hover transition-colors',
  ...
  statusBadge: {
    completed: 'inline-flex py-1 px-2 bg-ak-status-success/20 border border-ak-status-success rounded-ak-sm text-ak-status-success text-xs font-medium',
    pending: 'inline-flex py-1 px-2 bg-yellow-500/20 border border-yellow-500 rounded-ak-sm text-yellow-500 text-xs font-medium',
    failed: 'inline-flex py-1 px-2 bg-ak-status-error/20 border border-ak-status-error rounded-ak-sm text-ak-status-error text-xs font-medium',
    refunded: 'inline-flex py-1 px-2 bg-gray-500/20 border border-gray-500 rounded-ak-sm text-gray-500 text-xs font-medium',
  },
  typeBadge: {
    invoice: 'inline-flex py-1 px-2 bg-blue-500/20 border border-blue-500 rounded-ak-sm text-blue-500 text-xs font-medium',
    subscription: 'inline-flex py-1 px-2 bg-purple-500/20 border border-purple-500 rounded-ak-sm text-purple-500 text-xs font-medium',
    package: 'inline-flex py-1 px-2 bg-green-500/20 border border-green-500 rounded-ak-sm text-green-500 text-xs font-medium',
  },
  actions: 'flex gap-2',
  ...
  summaryCard: 'p-4 bg-surface rounded-ak-lg border border-border',
