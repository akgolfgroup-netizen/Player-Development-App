...
const tw = {
  ...
  card: 'bg-surface rounded-ak-lg border border-border p-6',
  ...
  statusBadge: {
    pending: 'inline-flex py-1 px-3 bg-yellow-500/20 border border-yellow-500 rounded-ak-md text-yellow-500 text-sm font-semibold',
    paid: 'inline-flex py-1 px-3 bg-ak-status-success/20 border border-ak-status-success rounded-ak-md text-ak-status-success text-sm font-semibold',
    overdue: 'inline-flex py-1 px-3 bg-ak-status-error/20 border border-ak-status-error rounded-ak-md text-ak-status-error text-sm font-semibold',
    cancelled: 'inline-flex py-1 px-3 bg-gray-500/20 border border-gray-500 rounded-ak-md text-gray-500 text-sm font-semibold',
  },
  ...
  actionButton: 'py-2 px-4 bg-primary border-none rounded-ak-md text-white text-sm font-medium cursor-pointer hover:opacity-90 transition-opacity',
  secondaryButton: 'py-2 px-4 bg-surface-elevated border border-border rounded-ak-md text-[var(--text-inverse)] text-sm font-medium cursor-pointer hover:bg-surface-elevated-hover transition-colors',
  warningBox: 'p-4 bg-yellow-500/10 border border-yellow-500 rounded-ak-md flex items-start gap-3',
    ...
    <div className={`${tw.container} ${className}`}>
      ...
      {isOverdue && (
        <div className={tw.warningBox}>
          <div className={tw.warningIcon}>⚠️</div>
