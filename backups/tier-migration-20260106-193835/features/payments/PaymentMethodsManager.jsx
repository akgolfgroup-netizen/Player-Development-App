...
const tw = {
  ...
  addButton: 'py-2 px-4 bg-primary border-none rounded-ak-md text-white text-sm font-medium cursor-pointer hover:opacity-90 transition-opacity',
  methodsList: 'flex flex-col gap-3',
  methodCard: 'p-4 bg-surface rounded-ak-lg border border-border flex items-center gap-4',
  methodCardDefault: 'p-4 bg-surface rounded-ak-lg border-2 border-primary flex items-center gap-4',
  methodIcon: 'text-3xl',
  methodInfo: 'flex-1',
  methodType: 'text-sm font-semibold text-[var(--text-inverse)] mb-1',
  methodDetails: 'text-xs text-[var(--video-text-secondary)]',
  defaultBadge: 'py-1 px-2 bg-primary/20 border border-primary rounded-ak-sm text-primary text-xs font-medium',
  methodActions: 'flex gap-2',
  setDefaultButton: 'py-1.5 px-3 bg-surface-elevated border border-border rounded-ak-sm text-[var(--text-inverse)] text-xs font-medium cursor-pointer hover:bg-surface-elevated-hover transition-colors',
  removeButton: 'py-1.5 px-3 bg-ak-status-error/10 border border-ak-status-error rounded-ak-sm text-ak-status-error text-xs font-medium cursor-pointer hover:bg-ak-status-error/20 transition-colors',
  modal: 'fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4',
  modalCard: 'w-full max-w-md bg-surface rounded-ak-lg border border-border p-6 flex flex-col gap-4',
