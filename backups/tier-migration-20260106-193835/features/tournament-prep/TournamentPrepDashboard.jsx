...
const tw = {
  ...
  card: 'p-5 bg-surface rounded-ak-lg border border-border hover:border-primary transition-colors cursor-pointer',
  cardHeader: 'flex items-start justify-between mb-4',
  cardTitle: 'text-base font-semibold text-[var(--text-inverse)] m-0 flex-1',
  statusBadge: {
    draft: 'inline-flex py-1 px-2 bg-yellow-500/20 border border-yellow-500 rounded-ak-sm text-yellow-500 text-xs font-medium',
    ready: 'inline-flex py-1 px-2 bg-ak-status-success/20 border border-ak-status-success rounded-ak-sm text-ak-status-success text-xs font-medium',
  },
  ...
  actionButton: 'flex-1 py-2 px-3 bg-surface-elevated border border-border rounded-ak-md text-[var(--text-inverse)] text-xs font-medium cursor-pointer hover:bg-surface-elevated-hover transition-colors text-center',
  primaryActionButton: 'flex-1 py-2 px-3 bg-primary border-2 border-primary rounded-ak-md text-white text-xs font-medium cursor-pointer hover:bg-primary-hover transition-colors text-center',
  ...
  return (
    <div className={`${tw.container} ${className}`}>
      ...
      <div className={tw.header}>
        <h1 className={tw.title}>Turneringsforberedelse</h1>
