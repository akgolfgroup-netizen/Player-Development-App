...
const tw = {
  ...
  holeButton: 'py-2 px-3 bg-surface-elevated border border-border rounded-ak-md text-[var(--text-inverse)] text-sm font-medium cursor-pointer hover:bg-surface-elevated-hover transition-colors text-center',
  holeButtonActive: 'py-2 px-3 bg-primary border-2 border-primary rounded-ak-md text-white text-sm font-medium cursor-pointer text-center',
  holeButtonCompleted: 'py-2 px-3 bg-ak-status-success/20 border-2 border-ak-status-success rounded-ak-md text-ak-status-success text-sm font-medium cursor-pointer text-center',
  ...
  textarea: 'w-full py-2 px-3 bg-surface-elevated border border-border rounded-ak-md text-[var(--text-inverse)] text-sm placeholder-[var(--video-text-tertiary)] min-h-[80px] resize-y',
