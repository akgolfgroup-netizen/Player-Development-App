      ...
      <Page.Content>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 border border-ak-border-default rounded-lg focus:outline-none focus:ring-2 focus:ring-ak-primary"
                >
        ...
        <Page.Section card={true}>
          ...
          <div className="text-center py-8">
            <Mail size={48} className="mx-auto mb-4 text-ak-text-tertiary" />
