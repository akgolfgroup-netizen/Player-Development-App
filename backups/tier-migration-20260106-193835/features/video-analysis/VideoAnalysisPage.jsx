...
const tw = {
  ...
  tabs: 'flex gap-1 p-1 bg-surface-elevated rounded-ak-md',
  tab: 'flex-1 py-2 px-3 text-sm font-medium text-[var(--video-text-secondary)] bg-transparent border-none rounded-ak-sm cursor-pointer transition-all hover:bg-surface-elevated-hover',
  tabActive: 'flex-1 py-2 px-3 text-sm font-medium text-[var(--text-inverse)] bg-surface border-none rounded-ak-sm cursor-pointer',
