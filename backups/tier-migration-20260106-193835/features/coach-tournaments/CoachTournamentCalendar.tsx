    ...
    <div className="min-h-screen bg-ak-surface-base">
      ...
      <div className="py-6 px-6">
        <div className="flex items-center justify-between mb-5">
          <div>
            <h1 className="text-[28px] font-semibold text-ak-text-primary m-0 mb-1">
              Turneringskalender
            </h1>
            <p className="text-[15px] text-ak-text-secondary m-0">
        ...
        <div className="flex gap-6 flex-wrap items-center">
          <div className="flex items-center gap-2">
            <Trophy size={18} className="text-ak-text-tertiary" />
            <span className="text-[14px] text-ak-text-primary">
              <strong className="font-semibold">{stats.upcoming}</strong> kommende
            </span>
          </div>
          <div className="flex items-center gap-2">
            <Users size={18} className="text-ak-text-tertiary" />
            <span className="text-[14px] text-ak-text-primary">
              <strong className="font-semibold">{stats.withPlayers}</strong> med mine spillere
            </span>
          </div>
          <div className="flex items-center gap-2">
            <CheckCircle size={18} className="text-ak-text-tertiary" />
            <span className="text-[14px] text-ak-text-primary">
          ...
          {stats.pendingRegistrations > 0 && (
            <div className="flex items-center gap-2">
              <Clock size={18} className="text-ak-status-warning" />
              <span className="text-[14px] text-ak-text-primary">
      ...
      {/* Filters */}
      <div className="py-4 px-6 border-y border-ak-border-default flex gap-3 flex-wrap items-center">
        <div className="flex items-center gap-2 px-3.5 py-2 bg-ak-surface-subtle rounded-lg flex-1 max-w-[300px]">
          ...
          <input
            ...
            className="flex-1 border-none bg-transparent text-sm text-ak-text-primary outline-none placeholder:text-ak-text-tertiary"
          />
        </div>
                ...
                >
                  ...
                  <div className="flex items-center justify-between py-3 px-5 bg-ak-surface-subtle border-t border-ak-border-default">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        className="inline-flex items-center gap-2 px-4 py-2 bg-ak-primary text-white text-sm font-medium rounded-lg hover:bg-ak-primary/90 transition-colors"
                        onClick={(e) => {
                          e.stopPropagation();
        ...
        <>
          ...
          <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-ak-surface-base rounded-xl p-6 w-[500px] max-w-[90vw] max-h-[80vh] overflow-auto z-[101] shadow-2xl">
            ...
            <div className="flex gap-3">
              ...
              <button
                className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 bg-ak-primary text-white text-sm font-medium rounded-lg hover:bg-ak-primary/90 transition-colors"
      ...
      {messageModalOpen && messageTournament && (
        <>
          ...
          <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-ak-surface-base rounded-xl p-6 w-[500px] max-w-[90vw] max-h-[80vh] overflow-auto z-[101] shadow-2xl">
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-ak-primary/10 flex items-center justify-center">
                  <MessageSquare size={20} className="text-ak-primary" />
                </div>
                <div>
                  <h2 className="text-lg font-semibold text-ak-text-primary m-0">
                    Send melding
                  </h2>
            ...
            {/* Recipients */}
            <div className="mb-4">
              <label className="text-sm font-medium text-ak-text-primary mb-2 block">
                Mottakere ({messageTournament.myPlayers.filter(p => p.status === 'registered').length} spillere)
              </label>
              <div className="flex flex-wrap gap-2 p-3 bg-ak-surface-subtle rounded-lg">
                {messageTournament.myPlayers
                  .filter(p => p.status === 'registered')
                  .map((player) => (
                    <div
                      key={player.id}
                      className="flex items-center gap-1.5 py-1 px-2.5 bg-ak-surface-base rounded-full border border-ak-border-default"
                    >
                      <div className="w-5 h-5 rounded-full bg-ak-primary text-white text-[9px] font-semibold flex items-center justify-center">
                        {player.initials}
                      </div>
                      <span className="text-xs text-ak-text-primary">
                        {player.name}
            ...
            <div className="mb-5">
              ...
              <textarea
                ...
                className="w-full h-32 p-3 border border-ak-border-default rounded-lg text-sm text-ak-text-primary placeholder:text-ak-text-tertiary resize-none focus:outline-none focus:ring-2 focus:ring-ak-primary/20 focus:border-ak-primary"
              />
            </div>

            {/* Quick Templates */}
            <div className="mb-5">
              <label className="text-xs font-medium text-ak-text-tertiary mb-2 block uppercase tracking-wide">
                Hurtigmaler
              </label>
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 bg-ak-surface-subtle border border-ak-border-default rounded-full text-xs text-ak-text-secondary hover:bg-ak-primary/10 hover:text-ak-primary hover:border-ak-primary transition-colors"
                  >
                    {template}
                  </button>
                ))}
            ...
            <div className="flex gap-3">
              ...
              <button
                className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 bg-ak-primary text-white text-sm font-medium rounded-lg hover:bg-ak-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
