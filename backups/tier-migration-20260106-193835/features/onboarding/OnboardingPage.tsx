/**
 * OnboardingPage - AK Golf Academy
 *
  ...
  const renderWelcome = () => (
    <div style={{ textAlign: 'center', padding: '40px 20px' }}>
      <div style={{ marginBottom: 32 }}>
        <AKLogo size={80} color="var(--ak-primary)" />
      </div>
      <h1 style={{ fontSize: 28, fontWeight: 700, marginBottom: 16, color: 'var(--ak-text-primary)' }}>
        Velkommen til AK Golf Academy, {user?.firstName}!
      </h1>
      <p style={{ fontSize: 16, color: 'var(--ak-text-secondary)', maxWidth: 500, margin: '0 auto 32px' }}>
        Vi skal nå samle litt informasjon om deg for å lage en personlig årsplan
        tilpasset dine mål og tilgjengelighet.
      </p>
      <p style={{ fontSize: 14, color: 'var(--ak-text-muted)' }}>
  ...
  const renderAvailability = () => (
    <div style={{ padding: '20px' }}>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        />
        <p style={{ fontSize: 12, color: 'var(--ak-text-muted)', marginTop: 4 }}>
            ...
            return (
              <button
                ...
                style={{
                  padding: '8px 16px',
                  borderRadius: 20,
                  border: isSelected ? 'none' : '1px solid var(--ak-border-default)',
                  backgroundColor: isSelected ? 'var(--ak-primary)' : 'white',
                  color: isSelected ? 'white' : 'var(--ak-text-primary)',
                  cursor: 'pointer',
                  fontSize: 14,
                }}
              >
    ...
    <div style={{ textAlign: 'center', padding: '40px 20px' }}>
      {planGenerated ? (
        <>
          ...
          <p style={{ color: 'var(--ak-text-secondary)', marginBottom: 24 }}>
            Vi har laget en personlig treningsplan basert på dine mål og tilgjengelighet.
          </p>
          <p style={{ color: 'var(--ak-text-muted)', fontSize: 14 }}>
        ...
        <>
          ...
          <p style={{ color: 'var(--ak-text-secondary)', marginBottom: 32 }}>
          ...
          {error && (
            <div style={{
              padding: 16,
              backgroundColor: 'var(--ak-status-error-bg)',
              borderRadius: 8,
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <AKLogo size={32} color="var(--ak-primary)" />
          <div>
            <div style={{ fontSize: 14, fontWeight: 600 }}>
              {sections[currentStep].title}
            </div>
            <div style={{ fontSize: 12, color: 'var(--ak-text-muted)' }}>
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              border: '1px solid var(--ak-border-default)',
              backgroundColor: 'white',
              color: currentStep === 0 ? 'var(--ak-text-muted)' : 'var(--ak-text-primary)',
