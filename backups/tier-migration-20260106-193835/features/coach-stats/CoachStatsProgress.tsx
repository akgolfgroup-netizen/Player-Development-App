      ...
      <div className="bg-ak-surface-base rounded-2xl p-5 mb-6 border border-ak-border-default">
        ...
        <div className="grid grid-cols-3 gap-4">
          {topPerformers.map((player, index) => {
            ...
            const colors = medalColors[index] || { bg: 'bg-ak-surface-subtle', border: 'border-ak-border-default', badge: '', star: false };
            ...
            return (
              <div key={player.id} className={`rounded-xl p-4 relative ${colors.bg} border-2 ${colors.border}`}>
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-ak-text-primary m-0 text-center">
                      {player.name}
                    </p>
                ...
                <div className="flex items-center justify-between py-2 px-3 bg-ak-status-success/15 rounded-lg">
                  <span className="text-xs text-ak-text-secondary text-center">
                    HCP endring
                  </span>
                  <span className="text-lg font-bold text-ak-status-success text-center">
                    {player.hcpChange}
                  </span>
                </div>
              </div>
