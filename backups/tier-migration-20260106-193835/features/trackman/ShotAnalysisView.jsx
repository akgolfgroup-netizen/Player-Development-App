...
const tw = {
  ...
  mainCard: 'p-6 bg-surface rounded-ak-lg border border-border',
  ...
  shotType: 'py-1 px-3 bg-primary/20 border border-primary rounded-ak-sm text-primary text-sm font-medium',
  metricsGrid: 'grid grid-cols-2 md:grid-cols-3 gap-4 mb-6',
  metricCard: 'p-4 bg-surface-elevated rounded-ak-md',
  ...
  trajectoryPlaceholder: 'h-48 bg-surface-elevated rounded-ak-md flex items-center justify-center text-[var(--video-text-tertiary)] text-sm',
    ...
    <div className={`${tw.container} ${className}`}>
      ...
      <div className={tw.header}>
        ...
        {onClose && (
          <button
            onClick={onClose}
            className="py-2 px-4 bg-surface-elevated border border-border rounded-ak-md text-[var(--text-inverse)] text-sm font-medium cursor-pointer hover:bg-surface-elevated-hover transition-colors"
          >
            ✕ Lukk
          </button>
        )}
