...
const tw = {
  ...
  chartContainer: 'p-6 bg-surface rounded-ak-lg border border-border',
  clubList: 'flex flex-col gap-3',
  clubRow: 'flex items-center gap-4',
  clubName: 'w-24 text-sm font-semibold text-[var(--text-inverse)]',
  barContainer: 'flex-1 relative h-12 bg-surface-elevated rounded-ak-md overflow-hidden',
  ...
  gapGood: 'text-ak-status-success font-semibold',
  gapWarning: 'text-yellow-500 font-semibold',
  gapBad: 'text-ak-status-error font-semibold',
  summarySection: 'grid grid-cols-1 md:grid-cols-3 gap-4',
  summaryCard: 'p-4 bg-surface-elevated rounded-ak-lg',
      ...
      <div className={`${tw.container} ${className}`}>
        ...
        <div className={tw.header}>
          ...
          <div className={tw.headerActions}>
            ...
            >
              {calculating ? '⚙️ Beregner...' : '📊 Beregn Gapping'}
            </Button>
          </div>
        </div>
      ...
      <div className={tw.header}>
        ...
        <div className={tw.headerActions}>
          ...
          <Button
            ...
            disabled={calculating || saving}
          >
            {calculating ? '⚙️ Beregner...' : '🔄 Oppdater Gapping'}
          </Button>
        </div>
      </div>
