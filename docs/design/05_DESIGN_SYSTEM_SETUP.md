...
- Alle farger fra Figma kit lagt til (`ak-primary`, `ak-gold`, `ak-success`, etc.)
...
### Farger
- **Brand:** Blue Primary (#10456A), Blue Light, Foam, Ivory, Gold
...
<div className="bg-ak-ivory rounded-ak-lg shadow-ak-card p-6">
  ...
  <button className="bg-ak-primary text-white px-5 py-3 rounded-ak-md">
    Lagre
  </button>
</div>
```
...
3. **Sjekk at:**
   ...
   - Farger fungerer (bg-ak-primary, text-ak-gold, etc.)
