...
- Primary: Blue `#10456A`, Blue Light `#2C5F7F`
- Accents: Snow `#EDF0F2`, Surface `#EBE5DA`, Gold `#C9A227`
- Semantic: Success `#4A7C59`, Warning `#D4A84B`, Error `#C45B4E`
- Neutrals: Charcoal, Steel, Mist, Cloud

**Session Types** (Nytt i v2.1):
- 8 treningstype-farger harmonisert med Blue Palette 01
...
- `tailwind.config.js` - Tailwind config med full Blue Palette 01 fargeskala
