 ...
 * useAKFormula Hook
 *
 * Comprehensive hook for AK Golf formula system:
...
> = {
  ...
  'L-ARM': {
    label: 'Med armer',
    description: 'Kropp + armer, ingen kølle',
    recommendedCS: null,
  },
  'L-KØLLE': {
    label: 'Med kølle',
    description: 'Uten ball, fokus på posisjoner',
    recommendedCS: { min: 20, max: 40 },
  },
  'L-BALL': {
    label: 'Med ball',
    description: 'Lav hastighet, fokus på følelse',
