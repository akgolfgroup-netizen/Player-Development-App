...
function getFallbackData() {
  return {
    ...
    achievements: [
      { id: 1, icon: 'flame', title: '7-dagers streak', description: 'Trent 7 dager på rad' },
      { id: 2, icon: 'target', title: 'Presis putter', description: '50 putts på rad innenfor 1m' },
      { id: 3, icon: 'dumbbell', title: 'Jernvilje', description: 'Fullført 100 økter' },
    ],
    notifications: [
    ...
    calendarEvents: [
      ...
      { id: 3, title: 'Langspill - Driver', startTime: '13:00', endTime: '15:00', type: 'training', location: 'Driving Range' },
    ],
    upcomingSessions: [
