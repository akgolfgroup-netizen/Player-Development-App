...
const styles: Record<string, React.CSSProperties> = {
  ...
  header: {
    ...
    alignItems: 'center',
    padding: '8px 10px',
    borderBottom: '1px solid var(--tier-border-subtle)',
  },
  title: {
    fontWeight: 'bold',
    color: 'var(--tier-surface-card)',
  ...
  clearBtn: {
    padding: '2px 8px',
    fontSize: '10px',
    backgroundColor: 'var(--tier-surface-subtle)',
    color: 'var(--tier-surface-card)',
    border: 'none',
    borderRadius: '3px',
    cursor: 'pointer',
  ...
  eventItem: {
    ...
    padding: '4px 6px',
    marginBottom: '4px',
    backgroundColor: 'var(--tier-surface-dark-subtle)',
    borderRadius: '3px',
  },
  time: {
    color: 'var(--tier-text-secondary)',
    fontSize: '9px',
  },
  eventName: {
    color: 'var(--tier-accent-cyan)',
    fontWeight: 'bold',
  },
  payload: {
    color: 'var(--tier-text-tertiary)',
