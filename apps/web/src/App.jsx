      ...
      <ThemeProvider>
        <AuthProvider>
          ...
          <Route path="/welcome" element={
            <LandingHero
              tagline="Elite Golf Development"
              headline="Utvikle ditt fulle potensial"
              headlineHighlight="potensial"
              description="Systematisk talentutvikling for ambisiøse golfspillere. Spor fremgang, sett mål, og nå dine drømmer med AK Golf."
              primaryAction={{
                label: 'Kom i gang',
              ...
              navigation={[
                { label: 'Om oss', onClick: () => console.log('About') },
                { label: 'Funksjoner', onClick: () => console.log('Features') },
                { label: 'Priser', onClick: () => console.log('Pricing') },
              ]}
              features={{
                title: 'Alt du trenger for å nå toppen',
                subtitle: 'En komplett plattform for systematisk talentutvikling innen golf',
                items: [
                  {
                    title: 'Treningsplanlegging',
                    description: 'Strukturerte treningsplaner tilpasset ditt nivå og dine mål. Dag-, uke- og årsplaner.',
                  ...
                  {
                    title: 'Fremgangsanalyse',
                    description: 'Detaljert statistikk og Strokes Gained-analyse. Se nøyaktig hvor du forbedrer deg.',
                  ...
                  },
                  {
                    ...
                    description: 'NGFs kategorisystem (A-K) integrert. Spor dine tester og se hva som kreves for neste nivå.',
                  ...
                  {
                    title: 'Trener-kommunikasjon',
                    description: 'Direkte kontakt med dine trenere. Del fremgang, få tilbakemeldinger og hold fokus.',
