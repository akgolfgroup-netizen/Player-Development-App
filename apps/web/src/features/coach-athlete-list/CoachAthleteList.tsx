  ...
  return (
    <div className="min-h-screen bg-tier-surface-base">
      ...
      <PageHeader
        ...
        helpText="Alfabetisk oversikt over dine spillere. Klikk på en spiller for å se dokumentasjon, fremgang, treningsplan og notater. Bruk søkefunksjonen for å finne spesifikke spillere raskt."
      />
