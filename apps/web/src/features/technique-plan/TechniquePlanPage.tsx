...
import { Target, CheckCircle, Circle, TrendingUp, Plus, Edit2, Trash2, AlertCircle, Award, Trophy, Lock, Upload } from 'lucide-react';
...
export const TechniquePlanPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'tasks' | 'goals' | 'progression' | 'badges'>('tasks');
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      ...
      <StandardPageHeader
        ...
        helpText="Din tekniske treningsplan med oppgaver fra trener, Trackman-baserte mål og teknikkmerker. Fullfør oppgaver, spor fremgang og lås opp merker ved å nå tekniske milepæler."
        actions={
