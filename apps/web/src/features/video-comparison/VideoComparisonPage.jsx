...
const tw = {
  ...
  backButton: 'flex items-center gap-1 py-2 px-3 bg-surface border border-border rounded-ak-md text-[var(--text-secondary,rgba(255,255,255,0.7))] text-[13px] cursor-pointer',
  title: 'm-0 text-lg font-semibold text-[var(--text-primary,white)] flex-1',
  ...
  slotLabel: 'block text-xs font-semibold text-[var(--text-tertiary,rgba(255,255,255,0.5))] uppercase tracking-wide mb-3',
  slotIcon: 'w-12 h-12 mx-auto mb-3 text-[var(--text-tertiary,rgba(255,255,255,0.4))]',
  slotText: 'text-sm text-[var(--text-secondary,rgba(255,255,255,0.7))] m-0',
  slotVideoTitle: 'text-base font-semibold text-[var(--text-primary,white)] mb-2',
  slotVideoMeta: 'text-[13px] text-[var(--text-secondary,rgba(255,255,255,0.7))] m-0',
  vsLabel: 'text-2xl font-bold text-[var(--text-tertiary,rgba(255,255,255,0.3))]',
  ...
  modalTitle: 'm-0 text-base font-semibold text-[var(--text-primary,white)]',
  ...
  videoThumbnail: 'w-full aspect-video bg-surface flex items-center justify-center text-[var(--text-tertiary,rgba(255,255,255,0.4))]',
  videoOptionTitle: 'p-2 text-xs font-medium text-[var(--text-primary,white)] overflow-hidden text-ellipsis whitespace-nowrap',
  loadingContainer: 'flex-1 flex items-center justify-center flex-col gap-4 text-[var(--text-secondary,rgba(255,255,255,0.7))]',
