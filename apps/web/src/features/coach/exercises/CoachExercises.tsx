      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-start justify-between gap-2 mb-1">
            <h3 className="font-semibold text-ak-text-primary truncate">{exercise.name}</h3>
            {exercise.isFavorite && (
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <span className="text-xs text-ak-text-tertiary">{exercise.duration} min</span>
            {exercise.hasMedia && (
              <span className="flex items-center gap-1 text-xs text-ak-text-tertiary">
                <Play size={12} />
                Video
              </span>
            )}
    ...
    <div className="max-w-4xl mx-auto">
      ...
      {filteredExercises.length === 0 ? (
        <div className="text-center py-16 bg-ak-surface-card rounded-xl border border-ak-border-default">
          <Dumbbell size={48} className="mx-auto text-ak-text-tertiary mb-4" />
