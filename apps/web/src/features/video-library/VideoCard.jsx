...
const tw = {
  ...
  thumbnailPlaceholder: 'w-full h-full flex items-center justify-center bg-[var(--ak-surface-dark-elevated)] text-[var(--text-tertiary,rgba(255,255,255,0.3))]',
  ...
  reviewedBadge: 'absolute top-2 right-2 px-2 py-1 rounded-ak-sm bg-ak-status-success text-white text-[10px] font-semibold uppercase tracking-wide flex items-center gap-1 z-[5]',
};
