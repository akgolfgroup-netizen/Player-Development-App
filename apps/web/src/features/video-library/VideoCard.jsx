...
const tw = {
  ...
  thumbnailPlaceholder: 'w-full h-full flex items-center justify-center bg-[var(--ak-surface-dark,var(--ak-surface-dark-elevated))] text-[var(--ak-text-tertiary,rgba(255,255,255,0.3))]',
