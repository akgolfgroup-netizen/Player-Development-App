...
const tw = {
  ...
  dismissButton: 'py-2 px-3 bg-transparent border border-border rounded-ak-md text-[var(--video-text-secondary)] text-[13px] cursor-pointer',
  ...
  input: 'w-full py-2.5 px-3 bg-[var(--ak-surface-dark-elevated)] border border-border rounded-ak-md text-[var(--text-inverse)] text-sm',
  select: 'w-full py-2.5 px-3 bg-[var(--ak-surface-dark-elevated)] border border-border rounded-ak-md text-[var(--text-inverse)] text-sm cursor-pointer',
  uploadActions: 'flex justify-end gap-2 p-4 border-t border-border',
  cancelButton: 'py-2.5 px-5 bg-transparent border border-border rounded-ak-md text-[var(--video-text-secondary)] text-sm cursor-pointer',
