...
const tw = {
  ...
  requestTitle: 'm-0 text-sm font-semibold text-[var(--text-primary,white)]',
  requestDescription: 'mt-1 text-[13px] text-[var(--text-secondary,rgba(255,255,255,0.7))]',
  ...
  dismissButton: 'py-2 px-3 bg-transparent border border-border rounded-ak-md text-[var(--text-secondary,rgba(255,255,255,0.7))] text-[13px] cursor-pointer',
  ...
  uploadTitle: 'm-0 text-lg font-semibold text-[var(--text-primary,white)]',
  closeButton: 'w-8 h-8 flex items-center justify-center bg-transparent border-none rounded-ak-md text-[var(--text-secondary,rgba(255,255,255,0.7))] cursor-pointer text-xl',
  uploadBody: 'p-4',
  dropZone: 'flex flex-col items-center justify-center p-8 bg-[var(--ak-surface-dark-elevated)] border-2 border-dashed border-border rounded-ak-lg cursor-pointer transition-all duration-200',
  dropZoneActive: 'border-primary bg-primary/10',
  dropText: 'm-0 text-sm text-[var(--text-secondary,rgba(255,255,255,0.7))] text-center',
  dropSubtext: 'mt-1 text-xs text-[var(--text-tertiary,rgba(255,255,255,0.5))]',
  formGroup: 'mt-4',
  label: 'block mb-1 text-[13px] font-medium text-[var(--text-secondary,rgba(255,255,255,0.7))]',
  input: 'w-full py-2.5 px-3 bg-[var(--ak-surface-dark-elevated)] border border-border rounded-ak-md text-[var(--text-primary,white)] text-sm',
  select: 'w-full py-2.5 px-3 bg-[var(--ak-surface-dark-elevated)] border border-border rounded-ak-md text-[var(--text-primary,white)] text-sm cursor-pointer',
  uploadActions: 'flex justify-end gap-2 p-4 border-t border-border',
  cancelButton: 'py-2.5 px-5 bg-transparent border border-border rounded-ak-md text-[var(--text-secondary,rgba(255,255,255,0.7))] text-sm cursor-pointer',
  ...
  progressBar: 'h-2 bg-[var(--ak-surface-dark-elevated)] rounded overflow-hidden',
  progressFill: 'h-full bg-primary transition-[width] duration-300',
  progressText: 'mt-1 text-xs text-[var(--text-secondary,rgba(255,255,255,0.7))] text-center',
  fileInfo: 'flex items-center gap-3 p-3 bg-[var(--ak-surface-dark-elevated)] rounded-ak-md mb-4',
  fileIcon: 'w-10 h-10 flex items-center justify-center bg-primary/20 rounded-ak-md text-primary',
  fileName: 'flex-1 min-w-0 text-sm text-[var(--text-primary,white)] overflow-hidden text-ellipsis whitespace-nowrap',
  fileSize: 'text-xs text-[var(--text-tertiary,rgba(255,255,255,0.5))]',
  removeFileButton: 'p-1 bg-transparent border-none text-[var(--text-tertiary,rgba(255,255,255,0.5))] cursor-pointer text-lg',
};
