...
const tw = {
  ...
  uploadBody: 'p-4',
  dropZone: 'flex flex-col items-center justify-center p-8 bg-[var(--ak-surface-dark,var(--ak-surface-dark-elevated))] border-2 border-dashed border-border rounded-ak-lg cursor-pointer transition-all duration-200',
  ...
  input: 'w-full py-2.5 px-3 bg-[var(--ak-surface-dark,var(--ak-surface-dark-elevated))] border border-border rounded-ak-md text-[var(--ak-text-primary,white)] text-sm',
  select: 'w-full py-2.5 px-3 bg-[var(--ak-surface-dark,var(--ak-surface-dark-elevated))] border border-border rounded-ak-md text-[var(--ak-text-primary,white)] text-sm cursor-pointer',
  ...
  progressBar: 'h-2 bg-[var(--ak-surface-dark,var(--ak-surface-dark-elevated))] rounded overflow-hidden',
  ...
  fileInfo: 'flex items-center gap-3 p-3 bg-[var(--ak-surface-dark,var(--ak-surface-dark-elevated))] rounded-ak-md mb-4',
