...
const tw = {
  ...
  searchInput: 'w-full py-2.5 pr-3 pl-10 text-sm text-[var(--ak-text-primary,white)] bg-[var(--ak-surface-dark,var(--ak-surface-dark-elevated))] border border-border rounded-ak-md outline-none transition-colors duration-200 focus:border-primary',
  ...
  select: "py-2.5 pl-3 pr-9 text-sm text-[var(--ak-text-primary,white)] bg-[var(--ak-surface-dark,var(--ak-surface-dark-elevated))] border border-border rounded-ak-md outline-none cursor-pointer appearance-none bg-no-repeat bg-[right_10px_center] min-w-[150px] transition-colors duration-200 focus:border-primary",
  viewToggle: 'flex bg-[var(--ak-surface-dark,var(--ak-surface-dark-elevated))] rounded-ak-md p-1 gap-1',
