 ...
 *
 * Tabs:
 * 1. Utovere - List of all athletes
...
const CoachAthleteHub: React.FC = () => {
  ...
  return (
    <AppShellTemplate
      title="Utovere"
      subtitle={activeTabConfig?.description || 'Administrer dine utovere'}
    >
      <div id="coach-athletes-export">
        {/* Tab Navigation */}
        <div style={styles.tabContainer}>
          <div style={styles.tabList} role="tablist" aria-label="Utover-kategorier">
            {TABS.map((tab) => {
              const Icon = tab.icon;
