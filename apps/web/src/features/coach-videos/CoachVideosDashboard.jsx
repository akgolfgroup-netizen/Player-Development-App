...
const tw = {
  ...
  title: 'm-0 text-2xl font-bold text-[var(--ak-text-primary,white)]',
  subtitle: 'm-0 text-sm text-[var(--ak-text-secondary,rgba(255,255,255,0.7))]',
  ...
  statValue: 'text-[28px] font-bold text-[var(--ak-text-primary,white)]',
  statLabel: 'text-xs text-[var(--ak-text-secondary,rgba(255,255,255,0.7))] uppercase tracking-wide',
  ...
  modalTitle: 'm-0 text-lg font-semibold text-[var(--ak-text-primary,white)]',
  modalClose: 'p-2 bg-transparent border-none rounded-ak-md text-[var(--ak-text-tertiary,rgba(255,255,255,0.4))] cursor-pointer',
