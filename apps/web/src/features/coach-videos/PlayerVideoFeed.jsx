...
// Status colors
const STATUS_COLORS = {
  [REVIEW_STATUS.PENDING]: 'var(--warning)',
  [REVIEW_STATUS.IN_PROGRESS]: 'var(--accent)',
  [REVIEW_STATUS.REVIEWED]: 'var(--success)',
  [REVIEW_STATUS.NEEDS_FOLLOWUP]: 'var(--error)',
};
...
const tw = {
  ...
  thumbnailContainer: 'relative w-40 h-[90px] rounded-ak-md overflow-hidden shrink-0 bg-[var(--ak-surface-dark-elevated)]',
  ...
  actions: 'flex gap-2',
  actionButton: 'py-1.5 px-3 bg-[var(--ak-surface-dark-elevated)] border border-border rounded-ak-md text-[var(--text-secondary,rgba(255,255,255,0.7))] text-xs font-medium cursor-pointer flex items-center gap-1 transition-all duration-150',
