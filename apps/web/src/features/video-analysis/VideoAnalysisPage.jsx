...
const tw = {
  ...
  title: 'm-0 text-lg font-semibold text-[var(--text-primary,white)] overflow-hidden text-ellipsis whitespace-nowrap flex-1',
  ...
  sidebarTitle: 'm-0 text-sm font-semibold text-[var(--text-primary,white)]',
  ...
  commentBody: 'text-[13px] text-[var(--text-primary,white)] leading-snug',
  commentTime: 'text-[11px] text-[var(--text-tertiary,rgba(255,255,255,0.4))] mt-1',
  commentInput: 'flex gap-2 p-3 border-t border-border',
  textarea: 'flex-1 py-2 px-3 bg-[var(--ak-surface-dark-elevated)] border border-border rounded-ak-md text-[var(--text-primary,white)] text-[13px] resize-none min-h-[60px]',
  ...
  errorText: 'text-base text-[var(--text-primary,white)] m-0',
  errorSubtext: 'text-[13px] text-[var(--text-secondary,rgba(255,255,255,0.7))] m-0',
  retryButton: 'py-2.5 px-5 bg-primary border-none rounded-ak-md text-white text-sm font-medium cursor-pointer',
  emptyComments: 'p-4 text-center text-[var(--text-tertiary,rgba(255,255,255,0.4))] text-[13px]',
};
