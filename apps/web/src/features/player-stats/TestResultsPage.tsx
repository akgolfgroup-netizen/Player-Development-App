...
const TestResultsPage: React.FC = () => {
  ...
  const getTrendIcon = (trend?: string) => {
    switch (trend) {
      case 'up': return <TrendingUp size={14} color="var(--status-success)" />;
      case 'down': return <TrendingDown size={14} color="var(--status-error)" />;
                    ...
                    <div style={styles.testHeader}>
                      ...
                      <div style={styles.testResult}>
                        <div style={styles.resultValue}>
                          <span style={{
                            ...styles.valueNumber,
                            color: test.passed ? 'var(--status-success)' : 'var(--status-error)'
                          }}>
                    ...
                    <div style={styles.progressBar}>
                      <div
                        style={{
                          ...
                          backgroundColor: test.passed ? 'var(--status-success)' : 'var(--status-warning)',
                        }}
                      />
                    </div>
