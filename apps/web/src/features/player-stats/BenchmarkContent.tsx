...
const BenchmarkContent: React.FC = () => {
  ...
  return (
    <div style={styles.container}>
      ...
      <section style={styles.section}>
        ...
        <Card padding="md">
          <p style={styles.approachIntro}>
            Se hvordan PGA-proffene presterer fra ulike avstander.
          </p>
      ...
      <section style={styles.section}>
        <div style={styles.sectionHeader}>
          <SectionTitle style={{ margin: 0 }}>WAGR - Beste amatører</SectionTitle>
        ...
        <div style={styles.approachLieRow}>
          ...
          <div style={styles.approachLieStats}>
            <div style={styles.approachLieStat}>
              ...
              <span style={styles.approachLieMeta}>SG</span>
            </div>
            <div style={styles.approachLieStat}>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  heroIcon: {
    ...
    boxShadow: '0 4px 12px rgba(16, 69, 106, 0.25)',
  },
  heroTitle: {
