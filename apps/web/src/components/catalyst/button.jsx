...
const styles = {
  ...
  colors: {
    ...
    // TIER Golf Custom Colors (using semantic tokens)
    primary: [
    ...
    surface: [
      'text-ak-text-primary [--btn-hover-overlay:var(--color-black)]/5 [--btn-bg:var(--tier-surface-card)] [--btn-border:var(--border)]/80',
