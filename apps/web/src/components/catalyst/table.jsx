...
export function TableHeader({ className, ...props }) {
  ...
  return (
    <th
      ...
      className={clsx(
        className,
        'border-b border-b-zinc-950/10 px-4 py-2 font-medium first:pl-(--gutter,0.5rem) last:pr-(--gutter,0.5rem) dark:border-b-white/10',
...
export function TableCell({ className, children, ...props }) {
  ...
  return (
    <td
      ...
      className={clsx(
        className,
        'relative px-4 first:pl-(--gutter,0.5rem) last:pr-(--gutter,0.5rem)',
