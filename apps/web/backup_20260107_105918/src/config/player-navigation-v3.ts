    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/dashboard/varsler', label: 'Varsler', icon: 'NotificationsIcon', description: 'Viktige meldinger' },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        label: 'Logging',
        items: [
          { href: '/trening/logg', label: 'Logg trening', icon: 'AddIcon', description: 'Registrer treningsøkt' },
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/trening/plan', label: 'Treningsplan', icon: 'CalendarIcon', description: 'Ukentlig plan' },
        ],
      },
      {
        id: 'ovelser',
        label: 'Øvelser & Dokumentasjon',
        items: [
          ...
          { href: '/bevis', label: 'Bevis', icon: 'VideoIcon', description: 'Dokumenter fremgang' },
        ],
      },
      {
        id: 'testing',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/mer/varsler', label: 'Varsler', icon: 'NotificationsIcon', description: 'Varselinnstillinger' },
