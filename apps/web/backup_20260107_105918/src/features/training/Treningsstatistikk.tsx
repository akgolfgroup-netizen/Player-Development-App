...
const PYRAMID_LEVELS: PyramidLevel[] = [
  ...
  { id: 'FYS', label: 'Fysisk', color: 'var(--status-error)', bgColor: 'bg-error/10' },
  { id: 'TEK', label: 'Teknikk', color: 'rgb(var(--tier-gold))', bgColor: 'bg-#3B82F6teknikk/10' },
  { id: 'SLAG', label: 'Golfslag', color: 'rgb(var(--tier-navy))', bgColor: 'bg-#3B82F6golfslag/10' },
  { id: 'SPILL', label: 'Spill', color: 'var(--status-success)', bgColor: 'bg-success/10' },
