      ...
      <PageContainer paddingY="md" background="base">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-8">
          ...
          <Link
            ...
            className="flex items-center justify-center gap-2 px-4 py-3.5 rounded-xl bg-tier-white text-tier-navy border-2 border-tier-border-default text-sm font-semibold hover:bg-tier-surface-subtle transition-colors"
          >
            <Target size={18} />
            Registrer test
          </Link>
