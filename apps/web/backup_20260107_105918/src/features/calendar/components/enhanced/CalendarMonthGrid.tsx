...
export const CalendarMonthGrid: React.FC<CalendarMonthGridProps> = ({
  ...
  return (
    <div className="shadow-sm ring-1 ring-black/5 dark:ring-white/5 lg:flex lg:flex-auto lg:flex-col">
      {/* Weekday headers */}
      <div className="grid grid-cols-7 gap-px border-b border-tier-border-default bg-tier-border-default text-center text-xs font-semibold leading-6 text-tier-text-secondary lg:flex-none">
