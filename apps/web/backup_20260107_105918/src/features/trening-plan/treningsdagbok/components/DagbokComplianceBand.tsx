...
const styles = {
  ...
  complianceValue: (rate: number) => ({
    fontSize: '14px',
    fontWeight: 700,
    color: rate >= 80 ? 'var(--status-success)' : rate >= 50 ? 'var(--status-warning)' : 'var(--status-error)',
    ...
    <div className={className} style={styles.container}>
      ...
      <div style={styles.legend}>
        ...
        <div style={styles.legendItem}>
          <div style={styles.legendDot(
            complianceRate >= 80 ? 'var(--status-success)' :
            complianceRate >= 50 ? 'var(--status-warning)' : 'var(--status-error)'
          )} />
      ...
      <div style={styles.stats}>
        ...
        <div style={styles.statItem}>
          <span style={{
            ...styles.statValue,
            color: complianceRate >= 80 ? 'var(--status-success)' :
                   complianceRate >= 50 ? 'var(--status-warning)' : 'var(--status-error)',
          }}>
            {complianceRate >= 100 ? (
