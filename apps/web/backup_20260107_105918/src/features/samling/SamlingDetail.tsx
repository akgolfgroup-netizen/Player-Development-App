...
const statusConfig = {
  ...
  in_progress: { label: 'Pagar', color: 'var(--status-success)', bg: 'rgba(var(--success-rgb), 0.15)' },
...
const invitationStatusLabels: Record<string, { label: string; color: string }> = {
  invited: { label: 'Invitert', color: 'var(--status-warning)' },
  confirmed: { label: 'Bekreftet', color: 'var(--status-success)' },
  declined: { label: 'Avslatt', color: 'var(--status-error)' },
