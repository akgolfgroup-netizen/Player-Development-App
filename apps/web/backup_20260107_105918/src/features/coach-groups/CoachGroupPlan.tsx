...
const categoryColors: Record<string, { bg: string; text: string; label: string }> = {
  teknikk: { bg: 'var(--#EC489980)', text: 'rgb(var(--tier-gold))', label: 'Teknikk' },
  putting: { bg: 'var(--status-success-muted)', text: 'rgb(var(--status-success))', label: 'Putting' },
  kort_spill: { bg: 'var(--#3B82F680)', text: 'rgb(var(--tier-navy))', label: 'Kort spill' },
  langt_spill: { bg: 'var(--#10B98180)', text: 'rgb(var(--status-success))', label: 'Langt spill' },
  bane: { bg: 'var(--tier-warning/20)', text: 'rgb(var(--status-warning))', label: 'Bane' },
  mental: { bg: 'var(--#F59E0B80)', text: 'var(--tier-navy)', label: 'Mental' },
  fysisk: { bg: 'var(--#F59E0B80)', text: 'var(--tier-gold)', label: 'Fysisk' },
};
